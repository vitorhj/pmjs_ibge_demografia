...
function exp_label_ibge_demografiajgs_2022_0_eval_expression(context) {
    // 'Pop.: ' || V01006 || '\n' || 'Masc.: ' || V01007 || '\n' || 'Fem.: ' || V01008

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((((('Pop.: ' + feature.get('V01006') ) + '\n') + 'Masc.: ') + feature.get('V01007') ) + '\n') + 'Fem.: ') + feature.get('V01008') );
    } else {
        return ((((((('Pop.: ' + feature.get('V01006') ) + '\n') + 'Masc.: ') + feature.get('V01007') ) + '\n') + 'Fem.: ') + feature.get('V01008') );
    }
}
...
function exp_label_lim_bairros_1_eval_expression(context) {
    // chave + ' - ' + rotulo

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('chave')  + ' - ') + feature.get('rotulo') );
    } else {
        return ((feature.get('chave')  + ' - ') + feature.get('rotulo') );
    }
}